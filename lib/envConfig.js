...
export function validateEnvironment() {
  ...
  if (!jwtSecret || jwtSecret === 'super_secret_jwt_key_change_in_production') {
    if (isProduction) {
      ...
      warnings.push('JWT_SECRET is required before authentication can be used.');
    }
  }
...
// Call explicitly at runtime. Importing modules during a build does not need secrets.
